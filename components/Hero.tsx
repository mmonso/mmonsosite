      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 flex flex-col space-y-8 text-center lg:text-left animate-slide-up">
            ...
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-stone-900 leading-[1.1] tracking-tight font-normal">
              {CONTENT.heroTitle}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              ...
              <Button as="a" href="#sobre" variant="outline" className="px-8 py-4 text-lg bg-white/80 backdrop-blur-sm border-sage-300 hover:bg-white hover:border-sage-400">
                Saiba mais
              </Button>
            </div>
          ...
          <div className="order-1 lg:order-2 relative animate-fade-in">
            <div className="relative aspect-[4/5] md:aspect-square lg:aspect-[4/5] max-w-md lg:max-w-full mx-auto rounded-2xl overflow-hidden shadow-2xl shadow-sage-900/10 group">
              ...
              {/* Primary Image: marcelo-hero.jpg. Fallback to Unsplash if missing. */}
              <img
              ...
              {/* Quote Overlay Card - Positioned on top of the image */}
