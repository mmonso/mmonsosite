...
export const CTAFinal: React.FC = () => {
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 relative overflow-hidden" style={{ backgroundColor: '#2a3d35' }}>
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-white hover:bg-sage-50 text-[#2a3d35] font-semibold px-8 py-4 md:px-10 md:py-5 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl text-base md:text-lg active:scale-[0.98]"
        >
          Falar no WhatsApp agora
          <ArrowRight size={20} />
        </a>

        <p className="text-stone-500 text-sm mt-6">Sessões de 50 min · Seg–Sex, 9h–17h · CRP 12/27931</p>
      </div>
    </section>
  );
};
