        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="group p-8 rounded-2xl bg-white border border-sage-200 hover:shadow-md hover:border-sage-300 transition-all duration-300">
            ...
            <p className="text-stone-600 text-lg leading-relaxed font-light">
              Sessões de <span className="text-stone-900 font-medium">{CONTENT.sessionInfo.duration}</span>, com investimento de <span className="text-stone-900 font-medium">R$ 160</span> por sessão.
            </p>
          </div>
