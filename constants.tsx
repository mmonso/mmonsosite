...
export const CONTENT = {
  ...
  approachText: [
    "Minha prática clínica é orientada pela Gestalt-terapia, uma abordagem que compreende a pessoa em sua totalidade — pensamentos, emoções, corpo e contexto — sem separar quem você é de como você se relaciona.",
    "Na Gestalt, o foco está no presente: o que acontece agora, como você sente, como você reage, o que se repete. A partir daí, investigamos juntos os padrões que influenciam seus vínculos e sua forma de se comunicar.",
    "É uma abordagem que não busca te encaixar em um modelo ideal de pessoa ou de relacionamento. Ao contrário: o objetivo é ampliar sua consciência sobre si mesmo para que você possa fazer escolhas mais livres e autênticas.",
    "Cada processo é único, respeita o seu tempo e parte de onde você está — não de onde a teoria acha que você deveria estar."
  ],
  sessionInfo: {
    duration: "50 minutos",
